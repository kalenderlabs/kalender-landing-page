...
import { Users, Building2, Megaphone, Shield, TrendingUp, ChevronDown, ArrowRight, Menu, X } from "lucide-react"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full border border-gray-700 bg-gray-800/50 backdrop-blur-sm mb-8">
              ...
              <span className="text-gray-300 text-sm font-medium">Segmentos Atendidos</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">{t("segments_page.hero_title")}</h1>
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-light mb-8">{t("segments_page.hero_subtitle")}</p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-block px-4 py-2 bg-primary/10 rounded-full mb-4">
              <span className="text-primary font-semibold text-sm">Para Quem é a Kalender</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">Segmentos Atendidos</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Soluções personalizadas para diferentes tipos de negócio</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-8">
            <Card className="border-0 shadow-lg rounded-2xl hover:shadow-xl transition-all group">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <CardTitle className="text-lg">{t("segments_page.pros_title")}</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="text-gray-600 text-sm leading-relaxed">{t("segments_page.pros_desc")}</CardContent>
            </Card>

            <Card className="border-0 shadow-lg rounded-2xl hover:shadow-xl transition-all group">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="bg-secondary/10 p-3 rounded-lg group-hover:bg-secondary group-hover:text-white transition-colors">
                    <Building2 className="h-6 w-6 text-secondary group-hover:text-white" />
                  </div>
                  <CardTitle className="text-lg">{t("segments_page.clinics_title")}</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="text-gray-600 text-sm leading-relaxed">{t("segments_page.clinics_desc")}</CardContent>
            </Card>
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="bg-accent/10 p-3 rounded-lg group-hover:bg-accent group-hover:text-white transition-colors">
                    <TrendingUp className="h-6 w-6 text-accent group-hover:text-white" />
                  </div>
                  <CardTitle className="text-lg">{t("segments_page.sales_title")}</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="text-gray-600 text-sm leading-relaxed">{t("segments_page.sales_desc")}</CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg rounded-2xl hover:shadow-xl transition-all group">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="bg-primary/10 p-3 rounded-lg group-hover:bg-primary group-hover:text-white transition-colors">
                    <Megaphone className="h-6 w-6 text-primary group-hover:text-white" />
                  </div>
                  <CardTitle className="text-lg">{t("segments_page.ops_title")}</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="text-gray-600 text-sm leading-relaxed">{t("segments_page.ops_desc")}</CardContent>
            </Card>

            <Card className="border-0 shadow-lg rounded-2xl hover:shadow-xl transition-all group md:col-span-2 lg:col-span-2">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="bg-brand-purple/10 p-3 rounded-lg group-hover:bg-brand-purple group-hover:text-white transition-colors">
                    <Shield className="h-6 w-6 text-brand-purple group-hover:text-white" />
                  </div>
                  <CardTitle className="text-lg">{t("segments_page.corp_title")}</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="text-gray-600 text-sm leading-relaxed">{t("segments_page.corp_desc")}</CardContent>
            </Card>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-block px-4 py-2 bg-accent/10 rounded-full mb-4">
                <span className="text-accent font-semibold text-sm">Jornada do Cliente</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight">{t("segments_page.how_title")}</h2>
            </div>

            <div className="space-y-4">
              {(t("segments_page.how_steps") as unknown as string[]).map((step, index) => (
                <div key={step} className="flex items-start gap-4 bg-gradient-to-r from-gray-50 to-white p-6 rounded-xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all">
                  <div className="bg-gradient-to-br from-primary to-accent text-white rounded-lg w-10 h-10 flex items-center justify-center text-lg font-bold flex-shrink-0">
                    {index + 1}
                  </div>
